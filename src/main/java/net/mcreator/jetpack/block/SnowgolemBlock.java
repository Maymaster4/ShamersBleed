...
public class SnowgolemBlock extends JetpackModElements.ModElement {
	@ObjectHolder("jetpack:snowgolem")
	public static final Block block = null;
	public SnowgolemBlock(JetpackModElements instance) {
		super(instance, 19);
	}
