...
public class ElderguardianBlock extends JetpackModElements.ModElement {
	@ObjectHolder("jetpack:elderguardian")
	public static final Block block = null;
	public ElderguardianBlock(JetpackModElements instance) {
		super(instance, 55);
	}
