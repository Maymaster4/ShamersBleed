...
public class TurtleBlock extends JetpackModElements.ModElement {
	@ObjectHolder("jetpack:turtle")
	public static final Block block = null;
	public TurtleBlock(JetpackModElements instance) {
		super(instance, 26);
	}
