...
public class WanderingtraderBlock extends JetpackModElements.ModElement {
	@ObjectHolder("jetpack:wanderingtrader")
	public static final Block block = null;
	public WanderingtraderBlock(JetpackModElements instance) {
		super(instance, 28);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("wanderingtrader");
		}
