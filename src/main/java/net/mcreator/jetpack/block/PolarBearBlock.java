...
public class PolarBearBlock extends JetpackModElements.ModElement {
	@ObjectHolder("jetpack:polar_bear")
	public static final Block block = null;
	public PolarBearBlock(JetpackModElements instance) {
		super(instance, 18);
	}
