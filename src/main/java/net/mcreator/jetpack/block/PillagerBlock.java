...
public class PillagerBlock extends JetpackModElements.ModElement {
	@ObjectHolder("jetpack:pillager")
	public static final Block block = null;
	public PillagerBlock(JetpackModElements instance) {
		super(instance, 48);
	}
