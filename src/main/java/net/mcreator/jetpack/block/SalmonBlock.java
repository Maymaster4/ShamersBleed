...
public class SalmonBlock extends JetpackModElements.ModElement {
	@ObjectHolder("jetpack:salmon")
	public static final Block block = null;
	public SalmonBlock(JetpackModElements instance) {
		super(instance, 21);
	}
