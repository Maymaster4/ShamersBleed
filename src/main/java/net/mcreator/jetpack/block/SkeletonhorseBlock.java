...
public class SkeletonhorseBlock extends JetpackModElements.ModElement {
	@ObjectHolder("jetpack:skeletonhorse")
	public static final Block block = null;
	public SkeletonhorseBlock(JetpackModElements instance) {
		super(instance, 35);
	}
