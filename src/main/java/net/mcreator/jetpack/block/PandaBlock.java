...
public class PandaBlock extends JetpackModElements.ModElement {
	@ObjectHolder("jetpack:panda")
	public static final Block block = null;
	public PandaBlock(JetpackModElements instance) {
		super(instance, 39);
	}
