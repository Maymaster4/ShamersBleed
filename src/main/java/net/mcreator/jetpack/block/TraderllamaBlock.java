...
public class TraderllamaBlock extends JetpackModElements.ModElement {
	@ObjectHolder("jetpack:traderllama")
	public static final Block block = null;
	public TraderllamaBlock(JetpackModElements instance) {
		super(instance, 37);
	}
