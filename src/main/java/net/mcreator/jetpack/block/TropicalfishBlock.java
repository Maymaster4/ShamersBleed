...
public class TropicalfishBlock extends JetpackModElements.ModElement {
	@ObjectHolder("jetpack:tropicalfish")
	public static final Block block = null;
	public TropicalfishBlock(JetpackModElements instance) {
		super(instance, 25);
	}
