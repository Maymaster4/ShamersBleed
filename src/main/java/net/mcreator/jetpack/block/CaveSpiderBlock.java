...
public class CaveSpiderBlock extends JetpackModElements.ModElement {
	@ObjectHolder("jetpack:cave_spider")
	public static final Block block = null;
	public CaveSpiderBlock(JetpackModElements instance) {
		super(instance, 44);
	}
