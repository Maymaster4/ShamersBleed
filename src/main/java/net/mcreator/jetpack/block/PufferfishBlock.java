...
public class PufferfishBlock extends JetpackModElements.ModElement {
	@ObjectHolder("jetpack:pufferfish")
	public static final Block block = null;
	public PufferfishBlock(JetpackModElements instance) {
		super(instance, 29);
	}
