...
public class DonkeyBlock extends JetpackModElements.ModElement {
	@ObjectHolder("jetpack:donkey")
	public static final Block block = null;
	public DonkeyBlock(JetpackModElements instance) {
		super(instance, 30);
	}
