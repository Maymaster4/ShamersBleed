...
public class OcelotBlock extends JetpackModElements.ModElement {
	@ObjectHolder("jetpack:ocelot")
	public static final Block block = null;
	public OcelotBlock(JetpackModElements instance) {
		super(instance, 15);
	}
