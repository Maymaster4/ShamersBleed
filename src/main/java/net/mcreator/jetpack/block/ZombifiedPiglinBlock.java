...
package net.mcreator.jetpack.block;
...
public class ZombifiedPiglinBlock extends JetpackModElements.ModElement {
	@ObjectHolder("jetpack:zombified_piglin")
	public static final Block block = null;
	public ZombifiedPiglinBlock(JetpackModElements instance) {
		super(instance, 46);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("zombified_piglin");
		}
