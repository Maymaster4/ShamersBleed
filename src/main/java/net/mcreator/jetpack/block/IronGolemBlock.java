...
public class IronGolemBlock extends JetpackModElements.ModElement {
	@ObjectHolder("jetpack:iron_golem")
	public static final Block block = null;
	public IronGolemBlock(JetpackModElements instance) {
		super(instance, 42);
	}
