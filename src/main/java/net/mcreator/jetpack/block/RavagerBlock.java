...
public class RavagerBlock extends JetpackModElements.ModElement {
	@ObjectHolder("jetpack:ravager")
	public static final Block block = null;
	public RavagerBlock(JetpackModElements instance) {
		super(instance, 49);
	}
